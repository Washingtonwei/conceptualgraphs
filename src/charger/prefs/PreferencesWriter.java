...
public class PreferencesWriter {
    ...
    AdminPrefPanel adminPanel;
    
    File prefFile = new File(System.getProperty( "user.dir" ), Global.userPreferencesFilename );

    public PreferencesWriter( AppearancePrefPanel appearance, CompatibilityPrefPanel compat, 
            ActorsPrefPanel actors, CraftPrefPanel craftPanel, AdminPrefPanel adminPanel ) {
...
//            Global.Prefs.store( new FileOutputStream( prefsFilename ), Global.getInfoString() );
            JOptionPane.showMessageDialog( null, "Preferences saved in:\n" + prefFile.getAbsolutePath() );
        } catch ( IOException e ) {
    ...
    protected String prefsToString() {
        return "# " + Global.getInfoString() + Global.LineSeparator
                // Appearance prefs
                ...
                + StringPrefToString( "DatabaseFolder", Global.DatabaseFolder,
                ...
                + StringPrefToString( "CRAFTGridFolder", Global.CRAFTGridFolder,
                ...
                + "# =============== Admin panel preferences" + Global.LineSeparator
                + booleanPrefToString( "ShowBoringDebugInfo", Global.ShowBoringDebugInfo,
                adminPanel.ShowBoringDebugInfo.getToolTipText() )
                + intPrefToString( "maxIterations", SpringGraphLayout.maxIterations,
                "Maximum number of times to run the spring relaxation algorithm" )
                ...
                + intPrefToString( "defaultGraphObjectHeight", GraphObject.defaultDim.height, "height of a typical object" )
                + intPrefToString( "defaultGraphObjectWidth", GraphObject.defaultDim.width, "width of a typical object" )
