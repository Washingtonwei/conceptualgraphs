...
//  CharGer 2003
//
//  Created by Harry Delugach on 12/5/05.
...
/**
	Performs a basic counter function for charger. Actor's name is "counter".
 */
public class CounterPlugin implements charger.act.ActorPlugin
{
				...
				throws charger.exception.CGActorException
	{
		...
		try
		{
			...
			charger.Global.info( "Displaying the value for counter plugin " + interval );
		...
		//if ( outputs.size() > 0 )
			...
			//	((charger.obj.Concept)(inputs.get( 0 ))).getOutermostGraph().getOwnerFrame();
                        ...
                        out.setReferent( "" + counterValue++, true );       // here's where counter is updated
