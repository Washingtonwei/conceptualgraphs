...
/**
	Implements a clock, so that when its input changes, its output becomes the current clock
 */
public class SimpleActorPlugin implements charger.act.ActorPlugin
{
	...
	{
		return charger.act.GraphUpdater.createConceptList( 2, "T" );
	}
